# Generated by Django 5.2 on 2025-04-19 00:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('especialista_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='peluqueria.especialista')),
                ('usuario_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('servicio_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='peluqueria.servicio')),
            ],
        ),
        migrations.CreateModel(
